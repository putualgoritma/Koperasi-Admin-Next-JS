    ...
    <div className="flex items-center gap-2">
      ...
      <div className="form-control">
        <select
          ...
          className="relative z-20 w-20 appearance-none rounded border border-stroke bg-transparent py-1 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input"
        >
          {perPage == 10 ? (
          ...
          {perPage == 30 ? (
            <option value={"30"} disabled selected>
              30
            </option>
          ) : (
          ...
          {perPage == 50 ? (
            <option value={"50"} disabled selected>
              50
            </option>
          ) : (
