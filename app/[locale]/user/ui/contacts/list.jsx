import Update from "@/app/[locale]/user/ui/contacts/update";
    ...
    <table className="w-full table-auto">
      <thead>
        <tr className="bg-gray-2 text-left dark:bg-meta-4">
          ...
          <th className="min-w-[150px] py-4 px-4 font-medium text-black dark:text-white">
            {messagesIntl.user.contacts.code}
          </th>
          <th className="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white">
            {messagesIntl.user.contacts.email}
          </th>
          <th className="py-4 px-4 font-medium text-black dark:text-white">
            {messagesIntl.user.contacts.type}
          </th>
          <th className="py-4 px-4 font-medium text-black dark:text-white">
            Action
          </th>
      ...
      <tbody>
        {members.map((member, index) => (
          <tr key={index}>
            ...
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              <p className="text-black dark:text-white">{member.code}</p>
            </td>
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              <p className="text-black dark:text-white">{member.email}</p>
            </td>
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              <p className="text-black dark:text-white">{member.type}</p>
            </td>
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              <div className="flex items-center space-x-3.5">
                ...
                <Update
                  dataUpd={{ member: member, messagesIntl: messagesIntl }}
                />
              </div>
            </td>
          </tr>
