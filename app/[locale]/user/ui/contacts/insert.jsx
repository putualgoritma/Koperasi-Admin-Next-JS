...
export default function Insert({ setData, data, messagesIntl }) {
  ...
  return (
    <>
      <div
        className="cursor-pointer flex items-center justify-center rounded bg-primary py-3 px-6 text-white hover:bg-opacity-95 gap-2"
          ...
          <div className="modal-box w-11/12 max-w-5xl dark:bg-boxdark no-scrollbar overflow-hidden">
            ...
            <div className="border-b border-stroke py-2 dark:border-strokedark">
              <h3 className="font-medium text-black dark:text-white">
                {messagesIntl ? messagesIntl.input.button.list : ""}{" "}
                {messagesIntl ? messagesIntl.user.contacts.title : ""}
              </h3>
            </div>
