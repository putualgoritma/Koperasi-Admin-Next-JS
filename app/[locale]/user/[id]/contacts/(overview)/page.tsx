...
import Add from "@/app/[locale]/user/ui/contacts/add";
import Pagination from "@/app/[locale]/user/ui/contacts/pagination";
import List from "@/app/[locale]/user/ui/contacts/list";
import Export from "@/app/[locale]/user/ui/contacts/export";
import Filter from "@/app/[locale]/user/ui/contacts/filter";
import Search from "@/app/[locale]/user/ui/contacts/search";
import Loader from "@/components/common/Loader";
import SetPage from "@/app/[locale]/user/ui/contacts/page";
...
async function Index({
  ...
  const query ='https://koperasi-admin.younacosmetic.com/api/user/?page=' + currentPage + "&per_page=" + perPage + dataQry
